...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4f960b65cdf944_43355767',
  'has_nocache_code' => false,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f960b65cdf944_43355767')) {function content_4f960b65cdf944_43355767($_smarty_tpl) {?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
    <head>
        <title>Веб Гуру::Редактировать:ааа</title>
...
<form method="post" action="index.php?c=C_Edit&id=50">
    Название:
    <br/>
    ...
    <br/>
    <input type="hidden" name="id_article" value="50" />
