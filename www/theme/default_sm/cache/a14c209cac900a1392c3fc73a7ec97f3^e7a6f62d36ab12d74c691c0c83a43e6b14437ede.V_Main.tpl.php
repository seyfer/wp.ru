...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4fab83d92c5d88_87672055',
  'has_nocache_code' => false,
  'cache_lifetime' => 60,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fab83d92c5d88_87672055')) {function content_4fab83d92c5d88_87672055($_smarty_tpl) {?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
    <head>
        <title>Веб Гуру::Редактировать:третья11</title>
...
<form method="post" action="index.php?c=C_Edit&id=70">
    Название:
    <br/>
    <input type="text" name="title" value="третья11" />
    <br/>
    <br/>
    Содержание:
    <br/>
