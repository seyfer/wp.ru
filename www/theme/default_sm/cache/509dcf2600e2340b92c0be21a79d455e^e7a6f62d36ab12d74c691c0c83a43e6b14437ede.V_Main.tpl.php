...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4f9fac8db0baa4_04960196',
  'has_nocache_code' => false,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f9fac8db0baa4_04960196')) {function content_4f9fac8db0baa4_04960196($_smarty_tpl) {?>
...
<form name="menu_editor" method="post" action="?c=C_Menu_Editor">
    <ul>
                ...
                <table>
                    <tr>
                        <td name="name">Название:<input type="text" value="Главная" name="ancor"></td>
                ...
                <table>
                    <tr>
                        <td name="name">Название:<input type="text" value="Консоль редактора" name="ancor"></td>
