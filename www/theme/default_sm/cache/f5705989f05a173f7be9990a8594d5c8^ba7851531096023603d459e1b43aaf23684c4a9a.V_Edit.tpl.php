...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4f960afd1e92a5_59062215',
  'has_nocache_code' => false,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f960afd1e92a5_59062215')) {function content_4f960afd1e92a5_59062215($_smarty_tpl) {?><?php echo '<?'; ?> /*
...
<form method="post" action="index.php?c=C_Edit&id=48">
    Название:
    <br/>
    ...
    <br/>
    <input type="hidden" name="id_article" value="48" />
