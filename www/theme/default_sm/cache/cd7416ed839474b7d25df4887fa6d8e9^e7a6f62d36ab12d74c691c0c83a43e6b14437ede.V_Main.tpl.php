...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4f960b533253d1_64509452',
  'has_nocache_code' => false,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f960b533253d1_64509452')) {function content_4f960b533253d1_64509452($_smarty_tpl) {?>
    ...
    <body>
        <div class="main">
            ...
            <div class="content">
                                <ul>   
                        <li>
                <a href="index.php?c=C_Article&id=49">
                    ааа
                </a>
                <p>                   
                    ааа...
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=31">
                    )))))))))))))))))
                </a>
                <p>                   
                    )))))))))))))))))...
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=27">
                    абыр
                </a>
                <p>                   
                    абыр...
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=15">
                    fffff
                </a>
                <p>                   
                    fffff...
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=6">
                    первая
                </a>
                <p>                   
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=5">
                    вторая 
                </a>
                <p>                   
                    ...
                    <li>
                <a href="index.php?c=C_Article&id=1">
                    третья 
                </a>
                <p>                   
